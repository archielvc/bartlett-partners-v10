...
export function AboutValues() {
  ...
  const values = [
    ...
    },
    {
      ...
      description: "In a property market saturated with noise, we believe in the power of discretion when selling homes in Twickenham, Teddington and the surrounding areas of the Richmond borough. Not every buyer needs to see your property online. Not every sale needs to be broadcast across every portal. For many of our clients selling properties in Richmond upon Thames, privacy isn't a luxury. It's a necessity. We've built a carefully curated network of qualified buyers actively seeking properties in Twickenham, Teddington and across the wider Richmond upon Thames area, often securing sales before a home ever reaches the open market. Quiet doesn't mean slow. It means strategic, considered, and effective property sales.",
      image: images.about.a_val_1
    },
    {
      title: "Dedicated Focus",
      subtitle: "Dedicated Focus",
      description: "The best buyers aren't found by casting the widest net. They're found through targeted outreach, market intelligence, and relationships built over years in the Twickenham, Teddington and wider Richmond borough property market. By working with just 10 clients at a time, we can dedicate the attention needed to truly understand your home, identify the right buyers, and negotiate from a position of strength. Your property deserves more than to be just another listing. It deserves to be a priority.",
      image: images.about.a_val_2
    },
    {
      title: "Relentless Pursuit",
      subtitle: "Relentless Pursuit",
      description: "Selling a property in Twickenham, Teddington or the surrounding Richmond borough isn't a passive exercise. It requires persistence, insight, and an unwavering commitment to achieving the result you deserve. We don't wait for buyers to come to us. We find them. Through our established network, strategic property marketing, and deep understanding of the local property market in Richmond upon Thames, we connect exceptional homes with the right people. Every viewing is prepared for. Every offer is scrutinised. Every negotiation is handled with your best interests at heart.",
